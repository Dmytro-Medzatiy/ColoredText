module.exports = {
    ...
    Test: {
        BSlider: require('../../src/client/views/Test/BSlider.jsx'),
        ColorPanel: require('../../src/client/views/Test/ColorPanel.jsx'),
        ColoredText: require('../../src/client/views/Test/ColoredText.jsx')
    }
};